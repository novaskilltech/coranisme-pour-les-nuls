 ...
 * 2. Citations coraniques : exclusivement "Sourate [Nom], verset [N°]"
 * 3. Argument 9 : formulations strictement respectueuses relatives aux corrections et orientations divines
 * 4. Argument 5 : garantie particulière du Coran sans exclure la transmission fiable
 * 5. Argument 6 : Hafs transmetteur de la lecture de 'Asim (riwâyat Hafs 'an 'Asim)
 * 6. Argument 7 : les 4 éléments (interdiction, permission de rapporter, ordre d'écrire, ordre pour Abû Shâh)
 * 7. Argument 8 : hadîth au sens lexical (parole, discours, récit, nouvelle)
 */
