...
window.I18N_DATA['ary'] = {
  ...
  "ui": {
    ...
    "card3Desc": "كتاب «منكر السنة التائب» للكاتب صلاح الدين أحمد متاح فابور للتحميل المباشر وبأعلى جودة.",
    "card3Action": "تيليشارجي فابور دابا ←",
    "card3Tag": "نسخة عربية بجودة عالية",
    ...
    "card4Tag": "13 لغة",
    "sidebarBookPromoBadge": "✨ كتاب مهداة فابور (PDF)",
    "sidebarBookTitle": "منكر السنة التائب",
    "sidebarBookAuthor": "بقلم صلاح الدين أحمد",
    "sidebarBookDl": "📥 تيليشارجي PDF",
    "sidebarBook3D": "✨ شوف 3D",
    "topbarBookBadge": "كتاب فابور (PDF)",
    "modalBookHeader": "✨ كتاب جديد — الطبعة العربية الرسمية",
    "modalBookBadge": "شهادة وتجربة شخصية ومنهجية",
    "modalBookTitle": "مُنْكِرُ السُّنَّةِ التَّائِب",
    "modalBookSubtitle": "كيفاش واحد كان منكر للسنة رجع وعرف قيمة ومكانة النبي ﷺ وتفككو الشبهات",
    "modalBookAuthor": "بقلم <strong>صلاح الدين أحمد</strong>",
    "modalBookDesc": "هاد الكتاب كيعاود المسار ديال باحث عاود كتاشف حجية ومكانة السنة النبوية الشريفة فالقرآن بعد سنوات من الشبهات، مع تفكيك مبسط لأفكار القرآنيين وطريق الرجوع للحق.",
    "modalBookMetaPdf": "📄 كتاب كامل PDF",
    "modalBookMetaHd": "⚡ طبعة عالية الدقة والجودة",
    "modalBookMetaFree": "🎁 متاح فابور للجميع 100%",
    "modalBookDownloadBtn": "📥 تيليشارجي الكتاب (PDF)",
    "modalBookContinueBtn": "كمل التصفح فالموقع",
    "modalBookFlipBtn": "🔄 قلب الكتاب (الجهة اللورانية)",
    "bookCoverFront": "couverture_arabe.png",
    "bookCoverBack": "arriere_arabe.png",
    "bookPdfFile": "MUNKIR_AL_SUNNA_AL_TAIB_EDITION_ARABE_FINALE.pdf",
    "bookSpineText": "منكر السنة التائب • صلاح الدين أحمد",
    ...
    "portalQuoteTransLabel": "ترجمة المعنى بالدارجة:",
    "portalQuoteText": "إلا سمعتي شي راجل كيتجبد ليه الأثر (الحديث المروي) وهو كيرفضو وكيقول: \"خلّي عليك هادشي وجيب لينا غي القرآن\"، ما تشكش أبدًا بلي راه غارق فالبدعة والضلال. نوض من المجلس ديالو وبعد منو!",
    "searchNoResults": "No results found for",
    "contactAuthorHeader": "مولّف الكتاب",
    ...
    "legalAuthorizedUsesList": [
      "التيليشارجومون، الطباعة، القراءة، والبارطاج فابور ديال هاد الجذاذات.",
      "الاستعمال فالحلقات التعليمية، الدروس، النقاشات ومواقع التواصل الاجتماعي.",
      "ممنوع منعا كليا أي استغلال تجاري أو تبديل وتحريف فالمحتوى بلا إذن مسبق."
    ],
    ...
    "legalPrivacyBullet2": "الخطوط والموارد: تحميل آمن من Google Fonts.",
    "legalCreditsHeader": "Book Details:",
    "legalCreditsBookTitle": "كيفاش تفضح وترد على فرقة القرآنيين — المنهج، الحجج، الشبهات والأجوبة",
    "footerSubtitle": "10 ديال الشبهات الكبار مفككين ومردود عليهم بالمنطق والدليل",
    ...
    "footerDownloadsTooltip": "عدد مرات تحميل كتاب «منكر السنة التائب» بصيغة PDF"
  },
  "arguments": [
    {
  ...
  "fallaciesToolbox": {
    ...
    "items": [
      ...
      },
      {
        "id": "non-sequitur",
        "num": 4,
        "name": "مغالطة الاستنتاج اللي ما عندو علاقة",
