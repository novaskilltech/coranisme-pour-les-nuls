...
window.I18N_DATA['ur'] = {
  ...
  "ui": {
    ...
    "portalQuoteTransLabel": "مفہوم کا ترجمہ:",
    "portalQuoteText": "جب تم کسی شخص کو سنو کہ اس کے سامنے حدیث یا اثر بیان کیا جائے اور وہ اسے رد کرتے ہوئے کہے: \"اسے چھوڑو اور ہمارے پاس صرف قرآن لاؤ\"، تو ہرگز شک نہ کرو کہ وہ شخص گمراہی اور بدعت میں ڈوبا ہوا ہے۔ اس کی مجلس سے اٹھ جاؤ اور اس سے دور رہو!",
    "searchNoResults": "No results found for",
    "contactAuthorHeader": "مصنف کتاب",
    ...
    "legalAuthorizedUsesList": [
      "مطالعاتی شیٹس کو مفت ڈاؤن لوڈ، پرنٹ، پڑھنا اور شیئر کرنا۔",
      "کلاسز، تعلیمی حلقات، مباحثوں اور سوشل میڈیا پر استعمال کرنا۔",
      "پیشگی اجازت کے بغیر کسی بھی قسم کا تجارتی استعمال یا متن میں تحریف سخت منع ہے۔"
    ],
    ...
    "legalPrivacyBullet2": "فانٹس اور وسائل: گوگل فانٹس کی محفوظ لوڈنگ۔",
    "legalCreditsHeader": "Book Details:",
    "legalCreditsBookTitle": "منکرین حدیث (قرآنیوں) کے شبہات اور ان کا مدلل رد — طریقہ کار، دلائل اور جوابات",
    "footerSubtitle": "10 بڑے شبہات کا تفصیلی اور منہجی رد",
    "footerBtnLegal": "⚖️ Sharing, License & Privacy",
    "footerBtnContact": "✉️ Contact Author",
    "footerBtnPortal": "📜 امام بربہاری کا قول",
