  ...
  "arguments": [
    {
      ...
      "number": "01",
      "title": "Le Coran est complet et détaillé : pourquoi faudrait-il la Sunna ?",
      "shortTitle": "Le Coran est complet et détaillé",
      "tagline": "Distinguer la complétude d'un système de son autosuffisance interprétative absolue",
      "formula": "COMPLÉTUDE DU CADRE ≠ EXHAUSTIVITÉ LITTÉRALE DE TOUTE MODALITÉ ≠ AUTOSUFFISANCE INTERPRÉTATIVE",
  ...
  "preface": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "distinctions": [
          {
            "term": "LES TRANSMETTEURS",
            "desc": "Qui avait transmis quoi ; de qui le transmetteur avait reçu son information ; si les deux personnes avaient réellement pu se rencontrer ; leur mémoire et leur honnêteté."
          },
          {
            "term": "LES RÉCITS",
            "desc": "Les variantes d'un même récit ; les chaînes parallèles ; les anomalies ; les contradictions apparentes ; les récits faibles et fabriqués."
          }
        ]
      },
      {
  ...
  "intro": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "distinctions": [
          {
            "term": "ÉPOQUE PROPHÉTIQUE",
            "desc": "Mise en garde contre celui qui oppose un ordre prophétique au seul texte coranique."
          },
          {
            "term": "204 H — ASH-SHÂFIʿÎ",
            "desc": "Jimâʿ al-ʿIlm : réfutation d'un groupe qui « rejetait tous les récits »."
          },
          {
            "term": "276 H — IBN QUTAYBAH",
            "desc": "Taʾwîl Mukhtalif al-Ḥadîth : réponse aux accusations de contradictions."
          },
          {
            "term": "329 H — AL-BARBAHÂRÎ",
            "desc": "Sharḥ As-Sunnah : mise en garde contre ceux qui demandent le Coran seul pour écarter l'athar."
          },
          {
            "term": "463 H — AL-KHATÎB AL-BAGHDÂDÎ",
            "desc": "Al-Kifâyah fî ʿIlm ar-Riwâyah : méthodologie de l'authentification."
          },
          {
            "term": "911 H — AS-SUYÛTÎ",
            "desc": "Miftâḥ al-Jannah : consensus sur l'obligation de suivre la Sunna."
          }
        ]
      }
    ]
