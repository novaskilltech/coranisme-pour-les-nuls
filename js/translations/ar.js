...
window.I18N_DATA['ar'] = {
  ...
  "ui": {
    ...
    "card3Desc": "كتاب «منكر السنة التائب» للمؤلف صلاح الدين أحمد متاح مجاناً للتحميل المباشر وبأعلى دقة.",
    "card3Action": "تحميل مجاني مباشر ←",
    "card3Tag": "نسخة عربية عالية الجودة",
    ...
    "card4Tag": "13 لغة",
    "sidebarBookPromoBadge": "✨ كتاب هدية (PDF)",
    "sidebarBookTitle": "منكر السنة التائب",
    "sidebarBookAuthor": "بقلم صلاح الدين أحمد",
    "sidebarBookDl": "📥 تحميل PDF",
    "sidebarBook3D": "✨ عرض ثلاثي الأبعاد",
    "topbarBookBadge": "كتاب مجاني (PDF)",
    "modalBookHeader": "✨ كتاب جديد — الطبعة العربية الرسمية",
    "modalBookBadge": "شهادة إيمانية ومنهجية",
    "modalBookTitle": "مُنْكِرُ السُّنَّةِ التَّائِب",
    "modalBookSubtitle": "كيف أعاد منكر للسنة النبوية اكتشاف مكانة الرسول ﷺ والرد على الشبهات",
    "modalBookAuthor": "بقلم <strong>صلاح الدين أحمد</strong>",
    "modalBookDesc": "يسرد هذا الكتاب مسار باحث أعاد اكتشاف حجية السنة ومكانة النبي ﷺ في القرآن الكريم بعد سنوات من الشبهات، مقدماً تفكيكاً عملياً لأطروحات القرآنيين ومنهج الرجوع إلى الحق.",
    "modalBookMetaPdf": "📄 كتاب كامل بصيغة PDF",
    "modalBookMetaHd": "⚡ طبعة عالية الدقة والجودة",
    "modalBookMetaFree": "🎁 متاح مجاناً للجميع 100%",
    "modalBookDownloadBtn": "📥 تحميل الكتاب (PDF)",
    "modalBookContinueBtn": "متابعة تصفح الموقع",
    "modalBookFlipBtn": "🔄 قلب الكتاب (الغلاف الخلفي)",
    ...
    "heroAuthor": "بقلم صلاح الدين أحمد (أبو سليمان)",
    ...
    "footerAuthorRef": "— صلاح الدين أحمد (أبو سليمان)",
    "footerNotice": "دليل منهجي مبني على مؤلف الشيخ صلاح الدين أحمد (أبو سليمان).",
    ...
    "portalDisclaimer": "دليل تفنيد شبهات القرآنيين • بقلم صلاح الدين أحمد (أبو سليمان) • نشر تعليمي متاح مع ذكر المصدر",
    ...
    "fallaciesTitle": "صندوق الأدوات المنطقية",
    "fallaciesBadgeTitle": "المغالطات المرصودة في هذه الشبهة :",
    "viewFallacyDetail": "عرض التحليل المفصل ▼",
    "hideFallacyDetail": "إخفاء التحليل ▲",
    ...
    "footerDownloadsTooltip": "إجمالي مرات تحميل كتاب «منكر السنة التائب» بصيغة PDF"
  },
  "arguments": [
    {
  ...
  "preface": {
    ...
    "title": "مقدمة المؤلف",
    "subtitle": "لماذا هذا الدليل المنهجي لتفنيد شبهات منكري السنة ؟",
    "introTag": "قبل البدء",
