      ...
      <article class="argument-detail-view" id="arg-view-${arg.id}">
        ...
        <div class="arg-body-content">
          ...
          <section id="section-their-thesis" class="nuls-callout callout-adverse">
            ...
            ${arg.theirArgument.verses && arg.theirArgument.verses.length > 0 ? `
          ...
          ${arg.quranicArchitecture && arg.quranicArchitecture.verses && arg.quranicArchitecture.verses.length > 0 ? `
