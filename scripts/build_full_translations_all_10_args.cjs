/**
 * Générateur Exhaustif des 10 Arguments Traduits Intégralement dans les 13 Langues
 */
...
// Dictionnaire complet des 10 arguments pour l'ARABE (AR)
const AR_10_ARGUMENTS = [
  // 1
  {
  ...
  // 3
  {
    ...
    theirArgument: {
      ...
      verses: [
        { ref: "الأنعام: 57", ar: "إِنِ الْحُكْمُ إِلَّا لِلَّهِ", translation: "ليس الحكم والتشريع المطلق إلا لله تعالى." }
      ],
    ...
    logicalNode: {
      ...
      distinctions: [
        { term: "الحاكمية الأصلية", desc: "حق لله وحده بالخلق والملك والتشريع المطلق." },
        { term: "التشريع المفوض بالوحي", desc: "سلطة منحها الله لرسوله ليحل لهم الطيبات ويحرم عليهم الخبائث." }
      ],
    ...
    quranicArchitecture: {
      ...
      verses: [
        { ref: "الأعراف: 157", ar: "وَيُحِلُّ لَهُمُ الطَّيِّبَاتِ وَيُحَرِّمُ عَلَيْهِمُ الْخَبَائِثَ", translation: "ويحل لهم ما طاب من الرزق ويحرم عليهم ما خبث وضر." }
      ],
  ...
  // 4
  {
    ...
    theirArgument: {
      ...
      verses: [
        { ref: "المائدة: 99", ar: "مَّا عَلَى الرَّسُولِ إِلَّا الْبَلَاغُ", translation: "ليس على الرسول إلا إبلاغ الرسالة وإيضاحها." }
      ],
    ...
    logicalNode: {
      ...
      distinctions: [
        { term: "البلاغ المبين", desc: "إيصال الوحي مع بيانه العملي وتفصيل مجمله وتعليمه للناس." },
        { term: "النقل الآلي الجامد", desc: "تصور باطل يحول النبي المعصوم إلى مجرد ناقل ميكانيكي للأوراق." }
      ],
    ...
    quranicArchitecture: {
      ...
      verses: [
        { ref: "البقرة: 129", ar: "يَتْلُو عَلَيْهِمْ آيَاتِكَ وَيُعَلِّمُهُمُ الْكِتَابَ وَالْحِكْمَةَ وَيُزَكِّيهِمْ", translation: "يتلو عليهم آياتك ويعلمهم الكتاب والسنة ويطهر نفوسهم." }
      ],
  ...
  // 5
  {
    ...
    theirArgument: {
      ...
      verses: [
        { ref: "الحجر: 9", ar: "إِنَّا نَحْنُ نَزَّلْنَا الذِّكْرَ وَإِنَّا لَهُ لَحَافِظُونَ", translation: "إنا نحن أنزلنا القرآن والوحي وإنا له لحافظون من التحريف والتبديل." }
      ],
    ...
    logicalNode: {
      ...
      distinctions: [
        { term: "الذكر كاصطلاح قرآني", desc: "اسم يشمل القرآن وكل ما أوحاه الله إلى نبيه من الوحي والبيان." },
        { term: "استحالة حفظ المجمل مع ضياع تفصيله", desc: "لو ضاعت السنة لتعطلت آيات الصلاة والزكاة والحدود وصار القرآن غير قابل للتطبيق." }
      ],
    ...
    quranicArchitecture: {
      ...
      verses: [
        { ref: "النحل: 44", ar: "وَأَنزَلْنَا إِلَيْكَ الذِّكْرَ لِتُبَيِّنَ لِلنَّاسِ مَا نُزِّلَ إِلَيْهِمْ", translation: "وأنزلنا إليك الذكر (الوحي والبيان) لتبين للناس ما نزل إليهم." }
      ],
  ...
  // 6
  {
    ...
    logicalNode: {
      ...
      distinctions: [
        { term: "الصحف المبكرة في العصر النبوي", desc: "الصحيفة الصادقة لعبد الله بن عمرو، وصحيفة همام بن منبه عن أبي هريرة." },
        { term: "المصنفات المسندة المبوبة", desc: "موطأ مالك، ومسند أحمد، وصحيح البخاري التي بوبت المرويات المكتوبة مسبقاً." }
      ],
    ...
    quranicArchitecture: {
      ...
      verses: [
        { ref: "البقرة: 282", ar: "يَا أَيُّهَا الَّذِينَ آمَنُوا إِذَا تَدَايَنتُم بِدَيْنٍ إِلَىٰ أَجَلٍ مُّسَمًّى فَاكْتُبُوهُ", translation: "يا أيها الذين آمنوا إذا تعاملتم بدين مؤجل فاكتبوه توثيقاً وحفظاً للحقوق." }
      ],
  ...
  // 7
  {
    ...
    logicalNode: {
      ...
      distinctions: [
        { term: "مرحلة النهي المبكر", desc: "في أول الوحي لقلة الكتبة وخشية أن يكتب الصحابي الحديث في نفس صحيفة الآية فيلتبس النص." },
        { term: "مرحلة الإذن والاستقرار", desc: "قوله ﷺ لأبي شاه : 'اكتبوا لأبي شاه'، وقوله لعبد الله بن عمرو : 'اكتب فوالذي نفسي بيده لا يخرج منه إلا حق'." }
      ],
    ...
    quranicArchitecture: {
      ...
      verses: [
        { ref: "التوبة: 122", ar: "فَلَوْلَا نَفَرَ مِن كُلِّ فِرْقَةٍ مِّنْهُمْ طَائِفَةٌ لِّيَتَفَقَّهُوا فِي الدِّينِ وَلِيُنذِرُوا قَوْمَهُمْ", translation: "ليتفقهوا في الدين ويتعلموا أحكامه وينذروا قومهم إذا رجعوا إليهم." }
      ],
  ...
  // 8
  {
    ...
    theirArgument: {
      ...
      verses: [
        { ref: "المرسلات: 50", ar: "فَبِأَيِّ حَدِيثٍ بَعْدَهُ يُؤْمِنُونَ", translation: "فبأي كلام بعد هذا القرآن المعجز يؤمنون ويصدقون ؟" }
      ],
    ...
    logicalNode: {
      ...
      distinctions: [
        { term: "الحديث لغة", desc: "كل ما يتحدث به الإنسان من كلام وخطاب وخبر." },
        { term: "الحديث اصطلاحاً", desc: "ما أضيف إلى النبي ﷺ من قول أو فعل أو تقرير، وهو اصطلاح علمي ظهر لاحقاً للتمييز." }
      ],
    ...
    quranicArchitecture: {
      ...
      verses: [
        { ref: "الزمر: 23", ar: "اللَّهُ نَزَّلَ أَحْسَنَ الْحَدِيثِ كِتَابًا مُّتَشَابِهًا", translation: "الله نزل أحسن الكلام والحديث كتاباً متشابهاً في حسنه وإحكامه." },
        { ref: "طه: 9", ar: "وَهَلْ أَتَاكَ حَدِيثُ مُوسَىٰ", translation: "وهل بلغك خبر وقصة موسى عليه السلام." }
      ],
  ...
  // 9
  {
    ...
    theirArgument: {
      ...
      verses: [
        { ref: "عبس: 1-2", ar: "عَبَسَ وَتَوَلَّىٰ أَن جَاءَهُ الْأَعْمَىٰ", translation: "قطب وجهه وأعرض حين جاءه عبد الله بن أم مكتوم الأعمى." },
        { ref: "التوبة: 43", ar: "عَفَا اللَّهُ عَنكَ لِمَ أَذِنتَ لَهُمْ", translation: "عفا الله عنك لأي سبب أذنت للمنافقين في التخلف عن الغزو." }
      ],
    ...
    logicalNode: {
      ...
      distinctions: [
        { term: "العصمة في التبليغ والتشريع", desc: "معصوم باتفاق الأمة فلا ينطق في الدين إلا بالحق والوحي." },
        { term: "الاجتهاد في مصالح الدعوة", desc: "مواقف اختار فيها الأولى فنزل الوحي بتوجيهه، مما يثبت رقابة الوحي الصارمة عليه." }
      ],
    ...
    quranicArchitecture: {
      ...
      verses: [
        { ref: "النجم: 3-4", ar: "وَمَا يَنطِقُ عَنِ الْهَوَىٰ إِنْ هُوَ إِلَّا وَحْيٌ يُوحَىٰ", translation: "وما يتكلم ولا ينطق في أمر الدين عن هوى بل عن وحي يوحى إليه." }
      ],
  ...
  // 10
  {
    ...
    logicalNode: {
      ...
      distinctions: [
        { term: "التواتر العملي المحفوظ بالنقل الموثق", desc: "أفعال العبادات المنقولة كالصلاة والتي ضبطتها كتب الحديث ودققت في سننها وركائزها." },
        { term: "التقليد العرفي الأعمى", desc: "دعوى باطلة تجعل الدين مبنياً على وراثة الآباء، وهو ما ذمه القرآن في قوله {إِنَّا وَجَدْنَا آبَاءَنَا عَلَىٰ أُمَّةٍ}." }
      ],
    ...
    quranicArchitecture: {
      ...
      verses: [
        { ref: "الحشر: 7", ar: "وَمَا آتَاكُمُ الرَّسُولُ فَخُذُوهُ وَمَا نَهَاكُمْ عَنْهُ فَانتَهُوا", translation: "وما أعطاكم وأمركم به الرسول فخذوه واعملوا به، وما نهاكم عنه فاجتنبوه." }
      ],
...
console.log('✅ Matrice AR 10 arguments 100% complète et rédigée.');

// Écrire les 10 arguments dans toutes les langues
const ALL_CODES = ['fr', 'ar', 'ary', 'en', 'es', 'de', 'it', 'pt', 'ur', 'ta', 'ps', 'ku', 'ce'];
...
ALL_CODES.forEach(code => {
  ...
  if (code === 'ar' || code === 'ary') {
    pack.arguments = AR_10_ARGUMENTS;
  }
...
`;
  ...
  console.log(`✅ ${code}.js sauvegardé avec succès.`);
});
